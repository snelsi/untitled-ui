...
const ZapSquare = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="m12 6-4.5664 6.2269c-.301.4105-.4516.6158-.4467.7873a.5001.5001 0 0 0 .1928.3805c.1354.1053.39.1053.899.1053H12V18l4.5664-6.2269c.301-.4105.4516-.6158.4467-.7873a.5002.5002 0 0 0-.1928-.3805c-.1354-.1053-.39-.1053-.899-.1053H12V6Z"
    />
  </svg>
);
