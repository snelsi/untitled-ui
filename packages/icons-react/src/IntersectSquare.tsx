...
const IntersectSquare = (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="M3 4.88c0-1.008 0-1.5121.1962-1.8972a1.8 1.8 0 0 1 .7866-.7866C4.3678 2 4.872 2 5.88 2h6.84c1.0081 0 1.5121 0 1.8972.1962a1.8 1.8 0 0 1 .7866.7866c.1962.385.1962.8891.1962 1.8972v6.84c0 1.0081 0 1.5121-.1962 1.8972a1.8 1.8 0 0 1-.7866.7866c-.3851.1962-.8891.1962-1.8972.1962H5.88c-1.008 0-1.5121 0-1.8972-.1962a1.8 1.8 0 0 1-.7866-.7866C3 13.2321 3 12.7281 3 11.72z"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
const ForwardRef = forwardRef(IntersectSquare);
